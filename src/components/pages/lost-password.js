      ...
      {!timeError && (
        <div>
          ...
          <form action="POST">
            ...
            <input class="form-input input-login" name="passA" placeholder="Digite uma nova senha" onChange={handleChange} type="password"></input>
            <label className="form-label">Repita a senha:</label>
            <input class="form-input input-login" name="passB" placeholder="Digite a senha novamente" onChange={handleChange} type="password"></input>
